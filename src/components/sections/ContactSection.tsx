    ...
    <section ref={ref} className="section-padding bg-card/50">
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:hello@softsmartz.com" className="font-medium text-foreground hover:text-primary transition-colors">
          ...
          >
            <form onSubmit={handleSubmit} className="card-elevated p-8 rounded-2xl space-y-6">
